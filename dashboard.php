...
$where_clause = ($filter_ibadah == 'Semua' || $filter_ibadah == '') ? "" : "WHERE jenis_ibadah = '$filter_ibadah'";
    ...
    <main class="flex-1 w-full p-4 md:p-8">
        <div class="mb-8">
            ...
            <p class="text-gray-500">
                <?= date('d F Y') ?> | <span id="jam-realtime" class="font-mono font-bold text-orange-600">00:00:00</span>
            </p>
